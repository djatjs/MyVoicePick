 ...
 * 2. MFCC 벡터는 17차원 배열 형태를 가집니다. 이를 DB에 저장하기 위해 문자열(JSON 문자열 등) 타입(TEXT)으로 관리합니다.
...
public class Song {
    ...
    @Builder
    public Song(String title, String artist, String mfccVector, Float zcrValue, Float rmsValue) {
        this.title = title;
        this.artist = artist;
