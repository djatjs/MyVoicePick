        ...
        <div className="w-full max-w-md">
          ...
          <div className="mvp-glass-card p-8 space-y-6">
            ...
            <div className="flex justify-center gap-6">
               {/* Naver */}
               <Link href="#" className="w-12 h-12 rounded-full bg-[#03C75A] flex items-center justify-center transition-opacity hover:opacity-80 shadow-lg" title="Naver Signup">
                  <span className="text-white font-black text-xl">N</span>
               </Link>
               {/* Kakao */}
               <Link href="#" className="w-12 h-12 rounded-full bg-[#FEE500] flex items-center justify-center transition-opacity hover:opacity-80 shadow-lg" title="Kakao Signup">
               ...
               {/* Google */}
               <Link href="#" className="w-12 h-12 rounded-full bg-white flex items-center justify-center transition-opacity hover:opacity-80 shadow-lg" title="Google Signup">
