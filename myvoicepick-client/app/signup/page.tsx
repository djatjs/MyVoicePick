          ...
          <div className="mvp-glass-card p-8 space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-[var(--mvp-text-muted)]">First Name</label>
                <input 
                  type="text" 
                  className="w-full bg-white/5 border border-white/10 rounded-[var(--mvp-radius-sm)] px-4 py-3 text-white focus:outline-none focus:border-indigo-500 transition-colors"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-bold uppercase tracking-widest text-[var(--mvp-text-muted)]">Last Name</label>
                <input 
                  type="text" 
                  className="w-full bg-white/5 border border-white/10 rounded-[var(--mvp-radius-sm)] px-4 py-3 text-white focus:outline-none focus:border-indigo-500 transition-colors"
                />
            ...
            <MvpButton variant="primary" className="w-full py-4">Create Account</MvpButton>

            <div className="relative">
              <div className="absolute inset-0 flex items-center"><span className="w-full border-t border-white/5"></span></div>
              <div className="relative flex justify-center text-[10px] uppercase tracking-[0.2em]"><span className="bg-[#1e293b] px-4 text-[var(--mvp-text-muted)]">소셜 계정으로 간편 가입</span></div>
            </div>

            <div className="flex justify-center gap-6">
               {/* Naver */}
               <Link href="http://localhost:8080/oauth2/authorization/naver" className="w-12 h-12 rounded-full bg-[#03C75A] flex items-center justify-center transition-opacity hover:opacity-80 shadow-lg" title="Naver Signup">
                  <span className="text-white font-black text-xl">N</span>
               </Link>
               {/* Kakao */}
               <Link href="http://localhost:8080/oauth2/authorization/kakao" className="w-12 h-12 rounded-full bg-[#FEE500] flex items-center justify-center transition-opacity hover:opacity-80 shadow-lg" title="Kakao Signup">
               ...
               {/* Google */}
               <Link href="http://localhost:8080/oauth2/authorization/google" className="w-12 h-12 rounded-full bg-white flex items-center justify-center transition-opacity hover:opacity-80 shadow-lg" title="Google Signup">
            ...
            <p className="text-[10px] text-[var(--mvp-text-muted)] text-center px-4 leading-relaxed">
